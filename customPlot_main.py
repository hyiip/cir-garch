...
parameter = {
    "FR": {
        "title": "(Panel B)\n2-year France government bond yield",
        "upper": "Upper Bound, η_U = 2.875",
        "main": "2Y France Gov. Bond Yield",
        "rawfile": "paper/bond/update/roll_lower_day30_SD750_GTFRF2Y.csv",
        "savepng": "paper/bond/update/fig1_FR.png",
        "saveeps": "paper/bond/update/fig1_FR.eps"
        },
    "US": {
        ...
        "savepng": "paper/bond/update/fig1_US.png",
        "saveeps": "paper/bond/update/fig1_US.eps"
        }
    }
current = "FR"
